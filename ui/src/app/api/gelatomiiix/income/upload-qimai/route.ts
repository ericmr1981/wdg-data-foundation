...
// POST /api/gelatomiiix/income/upload-qimai - 上传企迈收入明细 CSV 并触发导入
export async function POST(request: Request) {
  ...
  const scriptPath = path.join(projectRoot, 'scripts', 'import_gelatomiiix_income_detail.py');
  ...
  // 7. Read back import stats from raw.ingest_file
